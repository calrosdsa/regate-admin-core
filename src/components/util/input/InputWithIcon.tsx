...
const InputWithIcon = ({onChange,value,label,name,type="text",error,icon,className,placeholder="",required = true}:Props) =>{
  ...
  return(
    ...
    <input name={name}  type={type}
        ...
        value={value}
        // minLength={8}
        className={` border-[1px] rounded-lg rounded-b-lg p-2 h-9 w-full
